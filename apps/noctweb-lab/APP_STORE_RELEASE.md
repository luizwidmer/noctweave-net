...
```sh
xcodegen generate
open NoctwebLab.xcodeproj
```

Use scheme **NoctwebLab**, choose **Any Mac**, and archive. In Organizer, use Distribute App → App Store Connect. Xcode can create the app record on the first upload. The configured team is `9MY7SXN56X`; the bundle ID remains `net.noctweave.noctweb-lab`.
